...
<html>
    ...
    <!-- Inicio del navbar -->
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
          <a class="navbar-brand" href="index.jsp">Cliente</a>
    ...
    <!-- Inicio de crear Empleado -->
        <h1 align="center">Mantenimiento Clientes</h1>
        
        <table border ="1" width="600" align="center" class="table table-hover table-dark">
          <thead>
            <tr >
            <center><th colspan ="5">Mantenimiento de Clientes</th></center>
            </tr>
          </thead>    
            <tr>
                <th>Nit</th><th>Nombre Cliente</th>
            ...
            <tr>
               ...
               <th>
                    <a href="accliente.jsp?id=<%=rs.getString(1)%>">
