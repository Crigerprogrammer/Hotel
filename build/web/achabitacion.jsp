...
<html>
    ...
    <!-- Inicio de crear Empleado -->
         <%
            ...
            rs=sta.executeQuery("select * from habitaciones where id_habitacion='"+id+"'");
        ...
        <form action ="">
          <h2 class="text-primary">Actualizando Habitaciones</h2>  
          <div class="form-group">
            <label for="Nombre">ID</label>
            <input class="form-control" type="text" name="txtId" value="<%=rs.getString(1)%>" readonly="readonly">
          </div> 
          <div class="form-group">
            <label for="Estado">Tipo Habitacion</label><br>
            <input class="form-control" type="text" value="<%=rs.getString(2)%>" name="txtNom" >
          </div>
          <div class="form-group">
            <label for="CampoDireccion">Descripcion </label><br>
            <input class="form-control" type="text" name="txtDescripcion" value="<%=rs.getString(3)%>">
          </div>      
          <div class="form-group">
            <label for="CampoDireccion">Capacidad </label><br>
            <input class="form-control" type="text" name="txtCapacidad" value="<%=rs.getString(4)%>">
          </div>            
          <div class="form-group">
          <div class="form-group">
            ...
            <input class="form-control" type="text" name="txtIdH" value="<%=rs.getString(6)%>">
          </div>          
          <div class="form-group"> 
                <input class="btn btn-danger" type="submit" name="btnGrabar" value="Actualizar Habitacion"></th>
       </div>
        </form>
...
if(request.getParameter("btnGrabar")!=null){
            ...
            String est=request.getParameter("txtCapacidad");
            String dir=request.getParameter("txtEstado");
            int idh=Integer.parseInt(request.getParameter("txtIdH"));

            sta.executeUpdate("update habitaciones set tipo_habitacion='"+nom+"',descripcion='"+des+"',capacidad='"+est+"',estado='"+dir+"',id_hotel="+idh+" where id_habitacion="+ide+" ");

            request.getRequestDispatcher("cshabitacion.jsp").forward(request, response);
