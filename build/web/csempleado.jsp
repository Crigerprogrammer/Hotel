...
<html>
    ...
    <!-- Inicio de crear Empleado -->
        <h1 align="center">Mantenimiento Empleados</h1>
        
        <table border ="1" width="600" align="center" class="table table-hover table-dark">
          <thead>
            <tr >
            <center><th colspan ="5">Mantenimiento de Empleados</th></center>
            </tr>
          </thead>    
            <tr>
                <th>Id</th><th>Nombre</th>
                <th>Estado</th><th>Direccion</th>
                <th>Hotel</th><th>Accion</th>              
            </tr>
            <%
            Connection cnx=null;       
            Statement sta=null;
            ...
            rs=sta.executeQuery("SELECT e.id_empleado, e.nombre_empleado, e.estado, e.direccion, h.nombre FROM empleados e LEFT JOIN hoteles h ON e.id_hotel=h.id_hotel");
            ...
            <tr>
                ...
                <th>
                    <a href="acempleado.jsp?id=<%=rs.getString(1)%>">
