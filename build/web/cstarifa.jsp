...
<html>
    ...
    <!-- Inicio de crear Empleado -->
        <h1 align="center">Mantenimiento Tarifas</h1>
        
        <table border ="1" width="600" align="center" class="table table-hover table-dark">
          <thead>
            <tr >
            <center><th colspan ="5">Mantenimiento de Tarifas</th></center>
            </tr>
          </thead>    
            <tr>
            ...
            rs=sta.executeQuery("SELECT * FROM tarifas");
            ...
            <tr>
                ...
                <th>
                    <a href="actarifa.jsp?id=<%=rs.getString(1)%>">
