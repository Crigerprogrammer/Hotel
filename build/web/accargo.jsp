...
<html>
    ...
    <!-- Inicio de crear Empleado -->
         <%
            ...
            rs=sta.executeQuery("select * from cargosextras where id_sobrecargo='"+id+"'");
        ...
        <form action ="">
          <h2 class="text-primary">Actualizando Cargos Extras</h2>  
          ...
          <div class="form-group">
            ...
            <input class="form-control" type="text" value="<%=rs.getString(2)%>" name="txtDescripcion" >
          </div>
          <div class="form-group">
            <label for="CampoDireccion">Valor </label><br>
            <input class="form-control" type="number" name="txtValor" value="<%=rs.getString(3)%>">
          </div>      
          
          <div class="form-group"> 
                <input class="btn btn-danger" type="submit" name="btnGrabar" value="Actualizar Cargo Extra"></th>
       </div>
        </form>
...
if(request.getParameter("btnGrabar")!=null){
            ...
            int val=Integer.parseInt(request.getParameter("txtValor"));

            sta.executeUpdate("update cargosextras set descripcion='"+des+"',valor="+val+" where id_sobrecargo="+ide+" ");

            request.getRequestDispatcher("cscargo.jsp").forward(request, response);
