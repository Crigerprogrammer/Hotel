...
<html>
    ...
    <!-- Inicio de crear Empleado -->
         <%
            ...
            rs=sta.executeQuery("select * from reservaciones where id_reservacion='"+id+"'");
        ...
        <form action ="">
          <h2 class="text-primary">Actualizando Reservacion</h2>  
          <div class="form-group">
            <label for="Nombre">ID</label>
            <input class="form-control" type="text" name="txtId" value="<%=rs.getString(1)%>" readonly="readonly">
          </div> 
          <div class="form-group">
            <label for="Estado">Fecha Ingreso</label><br>
            <input class="form-control" type="date" value="<%=rs.getString(2)%>" name="txtFecha1" >
          </div>
          <div class="form-group">
            <label for="Estado">Fecha Salida</label><br>
            <input class="form-control" type="date" value="<%=rs.getString(3)%>" name="txtFecha2" >
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input class="form-control" type="text" name="txtCliente" value="<%=rs.getString(5)%>">
          </div> 
          <div class="form-group">
            <label for="CampoDireccion">ID TARIFA </label><br>
            <input class="form-control" type="number" name="txtTarifa" value="<%=rs.getString(6)%>">
          </div>      
          
          
          <div class="form-group"> 
                <input class="btn btn-danger" type="submit" name="btnGrabar" value="Actualizar Reservacion"></th>
       </div>
        </form>
...
if(request.getParameter("btnGrabar")!=null){
            ...
            sta.executeUpdate("UPDATE reservaciones SET fecha_ingreso='"+fecha1+"',fecha_salida='"+fecha2+"',id_habitacion="+hab+",nit_cliente='"+nit+"', id_tarifa="+tar+" WHERE id_reservacion="+ide+" ");

            request.getRequestDispatcher("csreservacion.jsp").forward(request, response);
