...
<html>
    ...
    <!-- Inicio de crear Empleado -->
         <%
            ...
            rs=sta.executeQuery("select * from tarifas where id_tarifa='"+id+"'");
        ...
        <form action ="">
          <h2 class="text-primary">Actualizando Tarifas</h2>  
          ...
          <div class="form-group"> 
                <input class="btn btn-danger" type="submit" name="btnGrabar" value="Actualizar Tarifa"></th>
       </div>
        </form>
...
if(request.getParameter("btnGrabar")!=null){
            ...
            sta.executeUpdate("update tarifas set descripcion='"+des+"',valor="+val+" where id_tarifa="+ide+" ");

            request.getRequestDispatcher("cstarifa.jsp").forward(request, response);
